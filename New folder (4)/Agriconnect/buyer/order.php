...
// Validate crop ID from query parameter
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Force buyers to purchase the entire available quantity.
    ...
    if ($order_quantity <= 0) {
        ...
        if ($stmt->execute([$buyer_id, $crop_id, $order_quantity, $total_price])) {
            // Update crop: set quantity to 0 and mark as unavailable
    ...
    <div class="container mt-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="fw-bold">Note: You must purchase the entire available quantity.</p>
                ...
                <?php else: ?>
                    <!-- Instead of asking for quantity, the form automatically processes the entire available quantity -->
